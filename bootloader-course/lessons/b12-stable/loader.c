/* Lesson B12: Mini-GRUB stage2 — 启动 TinyOS 主线（checkpoint）
 *
...
#endif
#define KERNEL_SECT  20u           /* 20 扇区 = 10240 字节 ≥ L05 kernel 10144 */
...
int loader_boot(void)
{
    ...
    vga_puts("B12 boot: entry=");
    vga_hex(loader_entry, 8);
    vga_puts(" mbi=");
    vga_hex(loader_mbi, 8);
    vga_puts("\n");
    vga_puts("B12 boot: jumping to kernel...\n");
