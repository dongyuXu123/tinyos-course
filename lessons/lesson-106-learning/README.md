# Lesson 106: concurrency, SMP, RCU, and diagnostics
...
Commands: `l106test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
