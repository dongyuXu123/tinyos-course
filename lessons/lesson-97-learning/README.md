# Lesson 97: VFS, devices, epoll, and service management
...
Commands: `l97test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
