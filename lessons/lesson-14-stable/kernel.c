/* Lesson 14: 32-bit bootstrap only builds the identity map and records handoff state. */
...
/* Temporary allocator for the five paging pages; no allocator state is handed off. */
