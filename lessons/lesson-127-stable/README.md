# Lesson 127: concurrency, SMP, RCU, and diagnostics
...
Commands: `l127test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
