# Lesson 84: VFS, devices, epoll, and service management
...
Commands: `l84test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
