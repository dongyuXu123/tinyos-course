/* Lesson 16: bootstrap retains the low map and builds a higher-half alias. */
...
struct long_mode_handoff {
    ...
    u64 high_pdpt, high_pd, high_pt0, high_pt1;
...
/* Temporary allocator for nine low-memory paging pages; no allocator state is handed off. */
...
{
    volatile u64 *pml4,*pdpt,*pd,*pt0,*pt1,*hpdpt,*hpd,*hpt0,*hpt1; u32 i;
    long_mode_handoff.pml4=bootstrap_alloc_page(); long_mode_handoff.pdpt=bootstrap_alloc_page(); long_mode_handoff.pd=bootstrap_alloc_page(); long_mode_handoff.pt0=bootstrap_alloc_page(); long_mode_handoff.pt1=bootstrap_alloc_page();
    ...
    if(!table_page_ok(long_mode_handoff.pml4)||!table_page_ok(long_mode_handoff.pdpt)||!table_page_ok(long_mode_handoff.pd)||!table_page_ok(long_mode_handoff.pt0)||!table_page_ok(long_mode_handoff.pt1)||!table_page_ok(long_mode_handoff.high_pdpt)||!table_page_ok(long_mode_handoff.high_pd)||!table_page_ok(long_mode_handoff.high_pt0)||!table_page_ok(long_mode_handoff.high_pt1)) return 0;
    zero_page(long_mode_handoff.pml4); zero_page(long_mode_handoff.pdpt); zero_page(long_mode_handoff.pd); zero_page(long_mode_handoff.pt0); zero_page(long_mode_handoff.pt1); zero_page(long_mode_handoff.high_pdpt); zero_page(long_mode_handoff.high_pd); zero_page(long_mode_handoff.high_pt0); zero_page(long_mode_handoff.high_pt1);
    pml4=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.pml4; pdpt=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.pdpt; pd=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.pd; pt0=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.pt0; pt1=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.pt1; hpdpt=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.high_pdpt; hpd=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.high_pd; hpt0=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.high_pt0; hpt1=(volatile u64 *)(unsigned long)(u32)long_mode_handoff.high_pt1;
