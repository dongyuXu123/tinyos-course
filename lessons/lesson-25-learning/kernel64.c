...
static TEXT64 volatile u64 *vm_pte_low(struct long_mode_handoff*h){return &((volatile u64 *)(unsigned long)h->pt1)[DYNAMIC_PT1_INDEX];}
static TEXT64 volatile u64 *vm_pte_high(struct long_mode_handoff*h){return &((volatile u64 *)(unsigned long)h->high_pt1)[DYNAMIC_PT1_INDEX];}
...
static TEXT64 void stack_guards_init(struct long_mode_handoff*h){volatile u64 *pt=(volatile u64 *)(unsigned long)h->high_pt0;u64 g[3]={(u64)(unsigned long)__idle_guard_start,(u64)(unsigned long)__rsp0_guard_start,(u64)(unsigned long)__ist1_guard_start};u32 i;for(i=0;i<3;i++){u64 off=g[i]-KERNEL_VMA_BASE;pt[off/PAGE_SIZE]=0;invlpg64(g[i]);}}
