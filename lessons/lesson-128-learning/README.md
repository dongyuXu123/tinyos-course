# Lesson 128: tracing ring buffer
...
Commands: `l121test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.

主要内容：tracing ring buffer
统一课程编号：Lesson 128
