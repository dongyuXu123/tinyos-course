# Lesson 128: concurrency, SMP, RCU, and diagnostics
...
Commands: `l128test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
