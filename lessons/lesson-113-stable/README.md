# Lesson 113: concurrency, SMP, RCU, and diagnostics
...
Commands: `l113test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
