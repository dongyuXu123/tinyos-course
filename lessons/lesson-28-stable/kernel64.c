...
extern void exception_bp(void); extern void exception_ud(void); extern void exception_pf(void); extern void irq0_entry(void); extern void irq1_entry(void); extern void enter_user_c(void);
...
static TEXT64 int vm_slot(u64 va,u32 *slot){if((va&(PAGE_SIZE-1))||va<VM_REGION_START||va>=VM_REGION_END)return 0;*slot=(u32)((va-VM_REGION_START)/PAGE_SIZE);if(*slot<2)return 0;return 1;}
