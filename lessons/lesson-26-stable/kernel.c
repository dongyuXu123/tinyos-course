...
static u32 setup_long_mode_tables(void)
{
    ...
    ((volatile u64 *)(unsigned long)(u32)long_mode_handoff.pt[PAGE_TABLES_PER_ALIAS-1])[PAGE_ENTRIES-1]=0;
    ((volatile u64 *)(unsigned long)(u32)long_mode_handoff.high_pt[PAGE_TABLES_PER_ALIAS-1])[PAGE_ENTRIES-1]=0;
