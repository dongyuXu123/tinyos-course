# Lesson 87: 负载均衡与进程组调度综合 checkpoint
...
Commands: `l80test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.

主要内容：负载均衡与进程组调度综合 checkpoint
统一课程编号：Lesson 87
