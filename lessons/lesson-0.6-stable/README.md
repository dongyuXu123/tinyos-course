# GRUB 研读 0.6：GRUB 生成 Multiboot information tags

> **Course status: stable study note.** 这是文档和工具分析课，不生成 TinyOS 内核。

## 学习目标

memory map、boot-loader-name、cmdline、modules、framebuffer，以及 TinyOS Lesson 05–08 的 MBI walker。
...
上一节点：`0.5`。下一节点：`0.7`。完成本课后进入下一节点；0.10 完成后进入 Lesson 01。
