# Lesson 162: 网络、namespace、cgroup、安全综合 checkpoint
...
Commands: `l155test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.

主要内容：网络、namespace、cgroup、安全综合 checkpoint
统一课程编号：Lesson 162
