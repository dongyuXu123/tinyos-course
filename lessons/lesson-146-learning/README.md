# Lesson 146: socket poll/epoll 集成
...
Commands: `l139test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.

主要内容：socket poll/epoll 集成
统一课程编号：Lesson 146
