# Lesson 125: concurrency, SMP, RCU, and diagnostics
...
Commands: `l125test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
