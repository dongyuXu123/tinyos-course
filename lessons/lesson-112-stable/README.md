# Lesson 112: concurrency, SMP, RCU, and diagnostics
...
Commands: `l112test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
