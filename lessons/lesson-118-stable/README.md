# Lesson 118: concurrency, SMP, RCU, and diagnostics
...
Commands: `l118test`, plus inherited process, GUI, and subsystem regressions. Session invariants remain preserved.
